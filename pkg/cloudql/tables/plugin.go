...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"platform_integration_resource_types": tablePlatformIntegrationResourceTypes(ctx),
			"platform_integrations_credentials":   tablePlatformIntegrationsCredentials(ctx),
